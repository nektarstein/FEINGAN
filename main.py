...
def train():
    ...
    for epoch in range(args.epochs):
        for index in range(args.batches):
            ...
            # Assuming g_loss and d_loss are lists, we take the first element if they are lists.
            ...
            print("epoch: %d, batch: %d, g_loss: %f, d_loss: %f" % (epoch, index, g_loss_val, d_loss_val))
